...
- Hub for audits and regeneration commands: [`docs/mass_balances/README.md`](../mass_balances/README.md).
- Explicit $\mathbf{S}\mathbf{I}^\top$ breakdown for all 114 process×element cells: [`audit-si-114cell.md`](../mass_balances/artifacts/audit-si-114cell.md) (regenerate with `uv run python scripts/generate_mass_balances_md.py`). Stub: [`docs/MASS_BALANCES.md`](../MASS_BALANCES.md).
- Experimental **O (water)** closure: [`stoichiometry_closure.py`](../../src/bioprocess_twin/models/stoichiometry_closure.py) (`build_petersen_matrix_with_oh_closure`), narrative [`OH_CLOSURE.md`](../mass_balances/guides/OH_CLOSURE.md), audit [`audit-oxygen-closure-114cell.md`](../mass_balances/artifacts/audit-oxygen-closure-114cell.md) (`uv run python scripts/generate_mass_balances_md.py --closure-of-oxygen`; `--closure` is a deprecated alias). Stub: [`MASS_BALANCES_CLOSURE_OF_OXYGEN.md`](../MASS_BALANCES_CLOSURE_OF_OXYGEN.md).
- Experimental **O + H (proton)** audit layer: same module (`build_petersen_matrix_with_oxygen_and_proton_closure`), rationale [`proton_closure_rationale.md`](../mass_balances/guides/proton_closure_rationale.md), audit [`audit-oxygen-proton-closure-114cell.md`](../mass_balances/artifacts/audit-oxygen-proton-closure-114cell.md) (`--closure-of-oxygen-and-protons`). **Does not** close charge or couple to SI.6 pH; **19×18** $\mathbf{S}$ is not yet wired to the 17-state ODE. Stub: [`MASS_BALANCES_CLOSURE_OF_PROTONS.md`](../MASS_BALANCES_CLOSURE_OF_PROTONS.md).
