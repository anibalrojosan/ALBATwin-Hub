...
**Tolerance:** `MASS_BALANCE_ATOL` from `src/bioprocess_twin/stoichiometry_validation.py` (currently `0.01`; tests import it via `tests/unit/stoichiometry_mass_balance_shared.py`). OK if $|B_{i,k}| \le$ atol.
