### Table SI.3.1: ALBA model stoichiometric matrix
...
| **Algae** | | | | | | | | | | | | | | | | | | |
| 1. Phototrophic growth on NH₄⁺         | 1     |       |       |      |      |      |       |       | α₁,₉  |       | α₁,₁₁ |       |       |       | α₁,₁₅ | α₁,₁₆ | α₁,₁₇ |
| 2. Phototrophic growth on NO₃⁻         | 1     |       |       |      |      |      |       |       | α₂,₉  |       |       |       | α₂,₁₃ |       | α₂,₁₅ | α₂,₁₆ | α₂,₁₇ |
| 3. Aerobic respiration                 | -1    |       |       |      |      |      |       |       | α₃,₉  |       | α₃,₁₁ |       |       |       | α₃,₁₅ | α₃,₁₆ | α₃,₁₇ |
| 4. Decay                               | -1    |       |       |      | α₄,₅ | α₄,₆ |       |       | α₄,₉  |       | α₄,₁₁ |       |       |       | α₄,₁₅ |       |       |
...
**Implementation alignment:** The numeric composition cells above match `src/bioprocess_twin/models/stoichiometry.py` (`get_composition_matrix`): $S_{IC}$ has no COD (0); $S_{N2}$ carries 1 g N per unit; H row uses $S_{IC,\mathrm{H}}=0$, $S_{ND,\mathrm{H}}=0.14$, $S_{NH,\mathrm{H}}=0.22$ (SI.3.1). Petersen $S_{O2}$ entries for processes 1–3 are $\alpha_{i,16}$ from Table SI.3.3, not literal $\pm 1$.